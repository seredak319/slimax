...
SimulationContext::SimulationContext(int numSnails,
                                     ...
                                     int pGrowthRate,
                                     int itCount)
        : m_numberOfSnails(numSnails)
        , m_snailAge(sAge)
        , m_snailAppetite(sAppetite)
        , m_snailGrowthRate(sGrowthRate)
        , m_numberOfPlants(numPlants)
        , m_plantVolume(pVolume)
        , m_plantGrowthRate(pGrowthRate)
